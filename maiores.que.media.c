...
.page-close:hover {
  background-image: url(/public/images/close_hover.png);
...
</style><script type="text/javascript" async="" src="./maiores.que.media_files/analytics.min.js.download"></script><script async="" src="./maiores.que.media_files/analytics.js.download"></script><script src="./maiores.que.media_files/polyfill.min.js.download" class="next-head"></script><script class="next-head">
    ...
    analytics.page();
    }}();</script><link rel="preload" href="./maiores.que.media_files/replEnvironment.js.download" as="script"><link rel="preload" href="./maiores.que.media_files/_error.js.download" as="script"><link rel="preload" href="./maiores.que.media_files/app.js.download" as="script"><style id="__jsx-3225118880">a.headerLink_notPrimary.jsx-3225118880:hover{color:#7896a3 !important;}
...
/*# sourceURL=ace/css/ace-tm */</style><style>    .error_widget_wrapper {        background: inherit;        color: inherit;        border:none    }    .error_widget {        border-top: solid 2px;        border-bottom: solid 2px;        margin: 5px 0;        padding: 10px 40px;        white-space: pre-wrap;    }    .error_widget.ace_error, .error_widget_arrow.ace_error{        border-color: #ff5a5a    }    .error_widget.ace_warning, .error_widget_arrow.ace_warning{        border-color: #F1D817    }    .error_widget.ace_info, .error_widget_arrow.ace_info{        border-color: #5a5a5a    }    .error_widget.ace_ok, .error_widget_arrow.ace_ok{        border-color: #5aaa5a    }    .error_widget_arrow {        position: absolute;        border: solid 5px;        border-top-color: transparent!important;        border-right-color: transparent!important;        border-left-color: transparent!important;        top: -5px;    }</style><style>.ace_snippet-marker {    -moz-box-sizing: border-box;    box-sizing: border-box;    background: rgba(194, 193, 208, 0.09);    border: 1px dotted rgba(211, 208, 235, 0.62);    position: absolute;}</style><style>.ace_editor.ace_autocomplete .ace_marker-layer .ace_active-line {    background-color: #CAD6FA;    z-index: 1;}.ace_editor.ace_autocomplete .ace_line-hover {    border: 1px solid #abbffe;    margin-top: -1px;    background: rgba(233,233,253,0.4);}.ace_editor.ace_autocomplete .ace_line-hover {    position: absolute;    z-index: 2;}.ace_editor.ace_autocomplete .ace_scroller {   background: none;   border: none;   box-shadow: none;}.ace_rightAlignedText {    color: gray;    display: inline-block;    position: absolute;    right: 4px;    text-align: right;    z-index: -1;}.ace_editor.ace_autocomplete .ace_completion-highlight{    color: #000;    text-shadow: 0 0 0.01em;}.ace_editor.ace_autocomplete {    width: 280px;    z-index: 200000;    background: #fbfbfb;    color: #444;    border: 1px lightgray solid;    position: fixed;    box-shadow: 2px 3px 5px rgba(0,0,0,.2);    line-height: 1.4;}</style><script src="./maiores.que.media_files/mode-c_cpp.js.download"></script></head><body><div><div id="__next"><div data-reactroot=""><div style="position:relative;min-height:100vh"><div id="modal-root"></div><div style="position:absolute;left:0;top:0;right:0;background:#F4F4F4;border-bottom:1px solid #E4E4E4;height:60px;text-align:center"><a style="position:absolute;left:25px;height:60px;line-height:94px;width:45px;overflow:hidden;border-bottom:none" href="https://repl.it/languages" class="jsx-3225118880 headerLink_notPrimary"><img style="width:116px" src="./maiores.que.media_files/logo-small.png" alt="repl.it"></a><div class="jsx-96056714 wrapper"><a style="border-bottom: none;"><div class="jsx-3986979567 profile-icon profile-icon-m" style="background-image: url(&quot;https://www.gravatar.com/avatar/?d=https://repl.it/public/images/evalbot/evalbot_17.png&amp;s=256&quot;); margin-right: 10px; width: 32px; height: 32px; flex-shrink: 0;"></div></a><div class="jsx-96056714 info-wrapper"><div style="font-size:14px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;max-width:100%" class="jsx-96056714"><a class="jsx-96056714 anon-user-link">@<!-- -->anonymous</a>/<!-- -->InsecureStrictStartup</div><div style="display:flex;max-width:100%" class="jsx-96056714"><img alt="C" title="C" src="./maiores.que.media_files/c.svg" style="height:16px;vertical-align:middle;margin-right:4px" class="jsx-96056714"><p style="font-size:12px;color:#787A7B;font-family:Questrial,sans-serif;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;max-width:100%" class="jsx-96056714">No description</p></div></div><div style="position:relative;width:15px;height:15px;margin-left:5px;margin-top:1px" data-radium="true"><div data-radium="true"><div style="background-size: contain; background-repeat: no-repeat; background-position: center center; cursor: pointer; width: 15px; height: 15px; background-image: url(&quot;/public/images/edit.png&quot;);" data-radium="true"></div></div></div></div><div style="position:relative;z-index:100000"><div><a class="jsx-520547632">Sign up</a></div></div></div><div id="page" style="padding-bottom:0"><div style="height:calc(100vh - 60px)"><div class="jsx-578987328 workspaceWrapper"><div class="jsx-578987328 windowManagerWrapper"><div style="height:100%"><div style="height:100%;display:flex;flex-direction:row"><div style="z-index:1;width:calc(50% - 5.5px);height:100%;display:flex;flex-direction:column"><div style="z-index:auto;height:50px;width:100%"><div style="display:flex;justify-content:center;align-items:center;height:50px;position:relative" class="jsx-2237786563"><div style="position:absolute;top:0;left:0;margin:15px"><div><div style="cursor:pointer;display:flex;justify-content:center;align-items:center;font-size:25px" class="jsx-2237786563"><div style="background-image:url(/public/images/settings_gear.png);height:22px;width:22px;background-size:contain;background-position:center;background-repeat:no-repeat;:hover:[object Object]" class="jsx-2237786563"></div></div></div></div><a class="jsx-2237786563 save-status" href="https://repl.it/repls/InsecureStrictStartup/history"><div class="jsx-2237786563 history-icon"><svg id="Layer_1_copy_5" data-name="Layer 1 copy 5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 21.051 18.415"><defs><style>
          ...
          </style></defs><title>HistoryIcon</title><path class="cls-1" d="M9.813,6.732a.485.485,0,0,1,.02-.154.262.262,0,0,1,.409-.139c.249.159,2.758,1.8,3.766,2.453a.47.47,0,0,1,.071.7.366.366,0,0,1-.067.052l-3.736,2.436a.314.314,0,0,1-.246.068.3.3,0,0,1-.217-.306C9.813,11.386,9.813,7.578,9.813,6.732Z"></path><path class="cls-2" d="M19.595,7.041A8.324,8.324,0,0,0,18.053,4a8.49,8.49,0,0,0-2.638-2.208A8.3,8.3,0,0,0,12.246.837,8.286,8.286,0,0,0,5.918,2.96,10.2,10.2,0,0,0,3.3,7.162C2.879,6.6,2.362,5.925,2.093,5.568,1.9,5.312,1.9,5.312,1.652,5.5c-.114.087-.228.174-.342.26-.229.171-.229.171-.059.4C2.062,7.23,2.877,8.3,3.679,9.38c.123.165.208.2.394.09,1.184-.683,2.375-1.354,3.564-2.025.032-.018.062-.032.094-.048a.106.106,0,0,0,.045-.147c-.14-.247-.232-.405-.331-.6-.084-.169-.173-.187-.334-.092-.643.375-2.035,1.154-2.083,1.178l-.263.15A10.5,10.5,0,0,1,7.7,3.694a6.579,6.579,0,0,1,3.271-1.133,6.85,6.85,0,0,1,2.847.38,6.353,6.353,0,0,1,2.039,1.195A6.53,6.53,0,0,1,18.1,8.382a6.415,6.415,0,0,1-.465,3.4,6.472,6.472,0,0,1-5.083,3.976,6.43,6.43,0,0,1-2.325-.037,6.538,6.538,0,0,1-2.111-.788,6.094,6.094,0,0,1-1.643-1.4.62.62,0,0,0-.948-.08,2.874,2.874,0,0,1-.278.221.622.622,0,0,0-.124.968,8.162,8.162,0,0,0,1.5,1.377A8.57,8.57,0,0,0,9.387,17.3a8.145,8.145,0,0,0,2.076.273h.089a8.23,8.23,0,0,0,2.72-.487,8.452,8.452,0,0,0,3.954-2.945,8.266,8.266,0,0,0,1.369-7.1ZM4.5,8.032l0-.006h.014Z"></path></svg></div><span class="jsx-2237786563">saved</span></a><div style="margin-left: 10px; width: auto;" class="jsx-2237786563 share-wrapper"><div class="jsx-4027189720 workspace-button"><span class="jsx-4027189720">share</span><span style="height:16px;width:20px" class="jsx-4027189720 workspace-button-icon"></span></div></div><div style="position: relative; margin-left: 10px; width: auto;"><div><div class="jsx-574672856 workspace-button workspace-button-active"><span class="jsx-574672856">stop</span><span style="height: 11px; width: 11.5px;" class="jsx-574672856 workspace-button-icon"></span></div></div></div><div style="position:absolute;right:0;display:flex;margin-right:.35em" class="jsx-2237786563"><div style="position:relative;margin:.4em"><div><a href="https://repl.it/repls/InsecureStrictStartup.zip" target="_blank" download="" class="jsx-2237786563"><div class="jsx-620985322 icon-button"></div></a></div></div><div style="position:relative;margin:.4em"><div><div class="jsx-2206701834 icon-button"></div></div></div></div></div></div><div style="z-index:1;height:calc(100% - 50px);width:100%" class="jsx-1742442620 wrapper"><div class="jsx-1742442620 tab-bar"><div class="jsx-1742442620 tab tab-active">main.c</div><div style="position:relative;display:inline-block"><div><div class="jsx-1742442620 new-tab"></div></div></div></div><div class="jsx-728821476 jsx-816848914" style="height: auto; position: relative; width: 100%; flex: 1 1 0%; display: block;"><div class="" style="position: relative; min-height: 60px; border-top: 0px; height: 100%;"><div class=" ace_editor ace-tm ace_focus" style="position: relative; height: 100%; font-size: 14px;" draggable="false"><textarea class="ace_text-input" wrap="off" autocorrect="off" autocapitalize="off" spellcheck="false" style="opacity: 0; height: 17px; width: 7.6975px; left: 153.067px; top: 85px;"></textarea><div class="ace_gutter"><div class="ace_layer ace_gutter-layer ace_folding-enabled" style="margin-top: 0px; height: 500px; width: 49px;"><div class="ace_gutter-cell " style="height: 17px;">1</div><div class="ace_gutter-cell " style="height: 17px;">2</div><div class="ace_gutter-cell " style="height: 17px;">3<span class="ace_fold-widget ace_start ace_open" style="height: 17px;"></span></div><div class="ace_gutter-cell " style="height: 17px;">4</div><div class="ace_gutter-cell " style="height: 17px;">5</div><div class="ace_gutter-cell " style="height: 17px;">6</div><div class="ace_gutter-cell " style="height: 17px;">7</div><div class="ace_gutter-cell " style="height: 17px;">8</div><div class="ace_gutter-cell " style="height: 17px;">9</div><div class="ace_gutter-cell " style="height: 17px;">10</div><div class="ace_gutter-cell " style="height: 17px;">11<span class="ace_fold-widget ace_start ace_open" style="height: 17px;"></span></div><div class="ace_gutter-cell " style="height: 17px;">12</div><div class="ace_gutter-cell " style="height: 17px;">13</div><div class="ace_gutter-cell " style="height: 17px;">14</div><div class="ace_gutter-cell " style="height: 17px;">15</div><div class="ace_gutter-cell " style="height: 17px;">16</div><div class="ace_gutter-cell " style="height: 17px;">17</div><div class="ace_gutter-cell " style="height: 17px;">18</div><div class="ace_gutter-cell " style="height: 17px;">19</div><div class="ace_gutter-cell " style="height: 17px;">20</div><div class="ace_gutter-cell " style="height: 17px;">21</div><div class="ace_gutter-cell " style="height: 17px;">22</div><div class="ace_gutter-cell " style="height: 17px;">23</div><div class="ace_gutter-cell " style="height: 17px;">24</div><div class="ace_gutter-cell " style="height: 17px;">25<span class="ace_fold-widget ace_start ace_open" style="height: 17px;"></span></div><div class="ace_gutter-cell " style="height: 17px;">26</div><div class="ace_gutter-cell " style="height: 17px;">27</div><div class="ace_gutter-cell " style="height: 17px;">28</div><div class="ace_gutter-cell " style="height: 17px;">29</div></div><div class="ace_gutter-active-line" style="top: 85px; height: 17px;"></div></div><div class="ace_scroller" style="left: 49px; right: 17px; bottom: 0px;"><div class="ace_content" style="margin-top: 0px; width: 612px; height: 500px; margin-left: 0px;"><div class="ace_layer ace_print-margin-layer"><div class="ace_print-margin" style="left: 619.8px; visibility: hidden;"></div></div><div class="ace_layer ace_marker-layer"><div class="ace_active-line" style="height:17px;top:85px;left:0;right:0;"></div></div><div class="ace_layer ace_text-layer" style="padding: 0px 4px;"><div class="ace_line_group" style="height: 17px;"><div class="ace_line" style="height:17px"><span class="ace_keyword">#include</span><span class="ace_constant ace_other"> &lt;stdio.h&gt;</span></div></div><div class="ace_line_group" style="height: 17px;"><div class="ace_line" style="height:17px"><span class="ace_storage ace_type">int</span> <span class="ace_identifier">main</span><span class="ace_paren ace_lparen">(</span><span class="ace_paren ace_rparen">)</span></div></div><div class="ace_line_group" style="height: 17px;"><div class="ace_line" style="height:17px"><span class="ace_paren ace_lparen">{</span></div></div><div class="ace_line_group" style="height: 17px;"><div class="ace_line" style="height:17px">  <span class="ace_storage ace_type">int</span> <span class="ace_identifier">num</span><span class="ace_paren ace_lparen">[</span><span class="ace_constant ace_numeric">10</span><span class="ace_paren ace_rparen">]</span><span class="ace_punctuation ace_operator">;</span></div></div><div class="ace_line_group" style="height: 17px;"><div class="ace_line" style="height:17px">  <span class="ace_storage ace_type">int</span> <span class="ace_identifier">i</span><span class="ace_punctuation ace_operator">;</span></div></div><div class="ace_line_group" style="height: 17px;"><div class="ace_line" style="height:17px">  <span class="ace_storage ace_type">int</span> <span class="ace_identifier">soma</span><span class="ace_keyword ace_operator">=</span><span class="ace_constant ace_numeric">0</span><span class="ace_punctuation ace_operator">;</span></div></div><div class="ace_line_group" style="height: 17px;"><div class="ace_line" style="height:17px">  <span class="ace_storage ace_type">float</span> <span class="ace_identifier">media</span><span class="ace_keyword ace_operator">=</span><span class="ace_constant ace_numeric">0</span><span class="ace_punctuation ace_operator">;</span></div></div><div class="ace_line_group" style="height:17px"><div class="ace_line" style="height:17px">  </div></div><div class="ace_line_group" style="height:17px"><div class="ace_line" style="height:17px">  </div></div><div class="ace_line_group" style="height:17px"><div class="ace_line" style="height:17px">  <span class="ace_keyword ace_control">for</span><span class="ace_paren ace_lparen">(</span><span class="ace_identifier">i</span><span class="ace_keyword ace_operator">=</span><span class="ace_constant ace_numeric">0</span><span class="ace_punctuation ace_operator">;</span><span class="ace_identifier">i</span><span class="ace_keyword ace_operator">&lt;</span><span class="ace_constant ace_numeric">10</span><span class="ace_punctuation ace_operator">;</span><span class="ace_identifier">i</span><span class="ace_keyword ace_operator">++</span><span class="ace_paren ace_rparen">)</span></div></div><div class="ace_line_group" style="height:17px"><div class="ace_line" style="height:17px">  <span class="ace_paren ace_lparen">{</span> </div></div><div class="ace_line_group" style="height:17px"><div class="ace_line" style="height:17px"><span class="ace_indent-guide">  </span>  <span class="ace_support ace_function ace_C99 ace_c">printf</span><span class="ace_paren ace_lparen">(</span><span class="ace_string ace_start">"</span><span class="ace_constant ace_language ace_escape">\n</span><span class="ace_string">Entre com um número: </span><span class="ace_string ace_end">"</span><span class="ace_paren ace_rparen">)</span><span class="ace_punctuation ace_operator">;</span></div></div><div class="ace_line_group" style="height:17px"><div class="ace_line" style="height:17px"><span class="ace_indent-guide">  </span>  <span class="ace_support ace_function ace_C99 ace_c">scanf</span><span class="ace_paren ace_lparen">(</span><span class="ace_string ace_start">"</span><span class="ace_constant ace_language ace_escape">%d</span><span class="ace_string ace_end">"</span><span class="ace_punctuation ace_operator">,</span><span class="ace_keyword ace_operator">&amp;</span><span class="ace_identifier">num</span><span class="ace_paren ace_lparen">[</span><span class="ace_identifier">i</span><span class="ace_paren ace_rparen">])</span><span class="ace_punctuation ace_operator">;</span></div></div><div class="ace_line_group" style="height:17px"><div class="ace_line" style="height:17px"><span class="ace_indent-guide">  </span>  </div></div><div class="ace_line_group" style="height:17px"><div class="ace_line" style="height:17px"><span class="ace_indent-guide">  </span>  <span class="ace_identifier">soma</span><span class="ace_keyword ace_operator">+=</span><span class="ace_identifier">num</span><span class="ace_paren ace_lparen">[</span><span class="ace_identifier">i</span><span class="ace_paren ace_rparen">]</span><span class="ace_punctuation ace_operator">;</span></div></div><div class="ace_line_group" style="height:17px"><div class="ace_line" style="height:17px">  <span class="ace_paren ace_rparen">}</span></div></div><div class="ace_line_group" style="height:17px"><div class="ace_line" style="height:17px">  </div></div><div class="ace_line_group" style="height:17px"><div class="ace_line" style="height:17px">  <span class="ace_identifier">media</span><span class="ace_keyword ace_operator">=</span><span class="ace_identifier">soma</span><span class="ace_keyword ace_operator">/</span><span class="ace_identifier">i</span><span class="ace_punctuation ace_operator">;</span></div></div><div class="ace_line_group" style="height:17px"><div class="ace_line" style="height:17px">  </div></div><div class="ace_line_group" style="height:17px"><div class="ace_line" style="height:17px">  <span class="ace_support ace_function ace_C99 ace_c">printf</span><span class="ace_paren ace_lparen">(</span><span class="ace_string ace_start">"</span><span class="ace_constant ace_language ace_escape">\n</span><span class="ace_string">A média da turma é: </span><span class="ace_constant ace_language ace_escape">%.</span><span class="ace_string">2f</span><span class="ace_string ace_end">"</span><span class="ace_punctuation ace_operator">,</span><span class="ace_identifier">media</span><span class="ace_paren ace_rparen">)</span><span class="ace_punctuation ace_operator">;</span></div></div><div class="ace_line_group" style="height:17px"><div class="ace_line" style="height:17px">  </div></div><div class="ace_line_group" style="height:17px"><div class="ace_line" style="height:17px">  <span class="ace_identifier">soma</span><span class="ace_keyword ace_operator">=</span><span class="ace_constant ace_numeric">0</span><span class="ace_punctuation ace_operator">;</span></div></div><div class="ace_line_group" style="height:17px"><div class="ace_line" style="height:17px">  </div></div><div class="ace_line_group" style="height:17px"><div class="ace_line" style="height:17px">  <span class="ace_keyword ace_control">for</span><span class="ace_paren ace_lparen">(</span><span class="ace_identifier">i</span><span class="ace_keyword ace_operator">=</span><span class="ace_constant ace_numeric">0</span><span class="ace_punctuation ace_operator">;</span><span class="ace_identifier">i</span><span class="ace_keyword ace_operator">&lt;</span><span class="ace_constant ace_numeric">10</span><span class="ace_punctuation ace_operator">;</span><span class="ace_identifier">i</span><span class="ace_keyword ace_operator">++</span><span class="ace_paren ace_rparen">)</span></div></div><div class="ace_line_group" style="height:17px"><div class="ace_line" style="height:17px">  <span class="ace_paren ace_lparen">{</span></div></div><div class="ace_line_group" style="height:17px"><div class="ace_line" style="height:17px"><span class="ace_indent-guide">  </span>  <span class="ace_keyword ace_control">if</span><span class="ace_paren ace_lparen">(</span><span class="ace_identifier">num</span><span class="ace_paren ace_lparen">[</span><span class="ace_identifier">i</span><span class="ace_paren ace_rparen">]</span><span class="ace_keyword ace_operator">&gt;</span><span class="ace_identifier">media</span><span class="ace_paren ace_rparen">)</span></div></div><div class="ace_line_group" style="height:17px"><div class="ace_line" style="height:17px"><span class="ace_indent-guide">  </span><span class="ace_indent-guide">  </span>  <span class="ace_identifier">soma</span><span class="ace_keyword ace_operator">++</span><span class="ace_punctuation ace_operator">;</span></div></div><div class="ace_line_group" style="height:17px"><div class="ace_line" style="height:17px">  <span class="ace_paren ace_rparen">}</span></div></div><div class="ace_line_group" style="height:17px"><div class="ace_line" style="height:17px">  </div></div></div><div class="ace_layer ace_marker-layer"></div><div class="ace_layer ace_cursor-layer"><div class="ace_cursor" style="left: 104.067px; top: 85px; width: 7.6975px; height: 17px;"></div></div></div></div><div class="ace_scrollbar ace_scrollbar-v" style="width: 22px; bottom: 0px;"><div class="ace_scrollbar-inner" style="width: 22px; height: 578px;"></div></div><div class="ace_scrollbar ace_scrollbar-h" style="display: none; height: 22px; left: 49px; right: 17px;"><div class="ace_scrollbar-inner" style="height: 22px; width: 637px;"></div></div><div style="height: auto; width: auto; top: 0px; left: 0px; visibility: hidden; position: absolute; white-space: pre; font-style: inherit; font-variant: inherit; font-weight: inherit; font-stretch: inherit; font-size: inherit; line-height: inherit; font-family: inherit; overflow: hidden;"><div style="height: auto; width: auto; top: 0px; left: 0px; visibility: hidden; position: absolute; white-space: pre; font-style: inherit; font-variant: inherit; font-weight: inherit; font-stretch: inherit; font-size: inherit; line-height: inherit; font-family: inherit; overflow: visible;"></div><div style="height: auto; width: auto; top: 0px; left: 0px; visibility: hidden; position: absolute; white-space: pre; font-style: inherit; font-variant: inherit; font-stretch: inherit; font-size: inherit; line-height: inherit; font-family: inherit; overflow: visible;">XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX</div></div></div></div></div></div></div><div style="height:100%;position:relative;display:flex;justify-content:center;align-items:center;z-index:1000;background:#DDD;flex:1 0 auto;overflow:hidden;cursor:col-resize;width:11px"><div style="height: 25px; border-right: 1px solid rgb(119, 120, 121);"></div></div><div style="z-index: 1; width: calc(50% - 5.5px); height: 100%; background-color: rgb(14, 22, 40);"><div class="jsx-3552593814" style="height: 100%; position: relative;"><div class="jsx-3552593814 terminal-opts"><span title="Input" class="jsx-3552593814 input-wrapper"><svg height="20" viewBox="0 0 48 48" width="20" xmlns="http://www.w3.org/2000/svg" class="jsx-3552593814 input-icon"><path d="M0 0h48v48h-48z" fill="none" class="jsx-3552593814"></path><path d="M42 6.02h-36c-2.21 0-4 1.79-4 4v7.98h4v-8.02h36v28.06h-36v-8.04h-4v8.02c0 2.21 1.79 3.96 4 3.96h36c2.21 0 4-1.76 4-3.96v-28c0-2.21-1.79-4-4-4zm-20 25.98l8-8-8-8v6h-20v4h20v6z" class="jsx-3552593814"></path></svg></span><span title="Clear" class="jsx-3552593814 clear-button"></span></div><div id="console" class="jsx-3552593814" style="position: relative; height: 100%;"><div style="position: absolute; left: 25%; right: 25%; top: 47%; height: 7px; background-color: transparent; border-style: solid; border-width: 1px; border-radius: 10px; border-color: rgb(255, 255, 255); transition: opacity 0.5s; z-index: 1; opacity: 0;"><div style="width: 100%; height: 5px; background-color: rgb(255, 255, 255);"></div></div><div style="top: 0px; left: 0px; right: 0px; bottom: 0px; position: absolute; overflow: auto;"><pre class="jqconsole jqconsole-blurred" style="margin: 0px; position: relative; min-height: 100%; box-sizing: border-box;"><span class="jqconsole-header"></span><span></span><span class="jqconsole-old-prompt"></span><span class="error"></span><span></span><span class="jqconsole-old-prompt"></span><span></span><span class="jqconsole-old-input"></span><span class="jqconsole-old-input"></span><span></span><span class="jqconsole-old-prompt"></span><span></span><span></span><span class="jqconsole-old-prompt"></span><span></span><span class="jqconsole-old-input"></span><span></span><span class="jqconsole-old-input"></span><span></span><span class="jqconsole-old-input"></span><span></span><span class="jqconsole-old-input"></span><span></span><span class="jqconsole-old-input"></span><span></span><span class="jqconsole-old-input"></span><span></span><span class="jqconsole-old-input"></span><span></span><span class="jqconsole-old-input"></span><span></span><span class="jqconsole-old-input"></span><span></span><span class="jqconsole-old-input"></span><span></span><span class="jqconsole-old-input"></span><span></span><span></span><span class="jqconsole-old-prompt"></span><span></span><span class="jqconsole-old-input"></span><span></span><span class="jqconsole-old-input"></span><span></span><span class="jqconsole-old-input"></span><span></span><span class="jqconsole-old-input"></span><span></span><span class="jqconsole-old-input"></span><span></span><span class="jqconsole-old-input"></span><span></span><span class="jqconsole-old-input"></span><span></span><span class="jqconsole-old-input"></span><span></span><span class="jqconsole-old-input"></span><span></span><span class="jqconsole-old-input"></span><span></span><span></span><span class="jqconsole-old-prompt"></span><span></span><span class="jqconsole-old-input"></span><span></span><span class="jqconsole-old-input"></span><span></span><span class="jqconsole-old-input"></span><span></span><span class="jqconsole-old-prompt"></span><span class="error"></span><span></span><span class="jqconsole-old-prompt"></span><span></span><span class="jqconsole-old-input"></span><span></span><span class="jqconsole-old-input"></span><span></span><span class="jqconsole-old-input"></span><span></span><span class="jqconsole-old-input"></span><span></span><span class="jqconsole-old-input"></span><span></span><span class="jqconsole-old-input"></span><span></span><span class="jqconsole-old-input"></span><span></span><span class="jqconsole-old-input"></span><span></span><span class="jqconsole-old-input"></span><span></span><span class="jqconsole-old-input"></span><span></span><span></span><span class="jqconsole-old-prompt"></span><span></span><span class="jqconsole-old-input"></span><span></span><span class="jqconsole-old-input"></span><span></span><span class="jqconsole-old-input"></span><span></span><span class="jqconsole-old-input"></span><span></span><span class="jqconsole-old-input"></span><span></span><span class="jqconsole-old-input"></span><span></span><span class="jqconsole-old-input"></span><span></span><span class="jqconsole-old-input"></span><span></span><span class="jqconsole-old-input"></span><span></span><span class="jqconsole-old-input"></span><span></span><span></span><span class="jqconsole-old-prompt"></span><span></span><span class="jqconsole-old-input"></span><span></span><span class="jqconsole-old-input"></span><span></span><span class="jqconsole-old-input"></span><span></span><span class="jqconsole-old-input"></span><span></span><span class="jqconsole-old-input"></span><span></span><span class="jqconsole-old-input"></span><span></span><span class="jqconsole-old-input"></span><span></span><span class="jqconsole-old-input"></span><span></span><span class="jqconsole-old-input"></span><span></span><span class="jqconsole-old-input"></span><span></span><span></span><span class="jqconsole-old-prompt"></span><span></span><span class="jqconsole-old-input"></span><span></span><span class="jqconsole-old-input"></span><span></span><span class="jqconsole-old-input"></span><span></span><span></span><span class="jqconsole-old-prompt"></span><span></span><span class="jqconsole-old-input"></span><span></span><span class="jqconsole-old-input"></span><span></span><span class="jqconsole-old-input"></span><span></span><span class="jqconsole-old-input"></span><span></span><span class="jqconsole-old-input"></span><span></span><span class="jqconsole-old-input"></span><span></span><span class="jqconsole-old-input"></span><span></span><span class="jqconsole-old-input"></span><span></span><span class="jqconsole-old-input"></span><span></span><span class="jqconsole-old-input"></span><span></span><span></span><span class="jqconsole-old-prompt"></span><span></span><span class="jqconsole-old-input"></span><span></span><span class="jqconsole-old-input"></span><span></span><span class="jqconsole-old-input"></span><span></span><span class="jqconsole-old-input"></span><span></span><span class="jqconsole-old-input"></span><span></span><span class="jqconsole-old-input"></span><span></span><span class="jqconsole-old-input"></span><span></span><span class="jqconsole-old-input"></span><span></span><span class="jqconsole-old-input"></span><span></span><span class="jqconsole-old-input"></span><span></span><span></span><span></span><span class="jqconsole-old-prompt"></span><span></span><span class="jqconsole-old-input"></span><span></span><span class="jqconsole-old-input"></span><span></span><span class="jqconsole-old-input"></span><span></span><span class="jqconsole-old-input"></span><span class="jqconsole-old-input"></span><span></span><span></span><span class="jqconsole-old-input"></span><span></span><span class="jqconsole-old-input"></span><span></span><span class="jqconsole-old-input"></span><span></span><span class="jqconsole-old-input"></span><span></span><span class="jqconsole-old-prompt"></span><span></span><span class="jqconsole-old-input"></span><span></span><span class="jqconsole-old-input"></span><span></span><span class="jqconsole-old-input"></span><span></span><span class="jqconsole-old-input"></span><span></span><span class="jqconsole-old-input"></span><span></span><span class="jqconsole-old-input"></span><span></span><span class="jqconsole-old-input"></span><span></span><span class="jqconsole-old-input"></span><span></span><span class="jqconsole-old-input"></span><span></span><span class="jqconsole-old-input"></span><span></span><span></span><span></span><span class="jqconsole-old-prompt"></span><span></span><span></span><span><span class="">gcc version 4.6.3
</span></span><span class="jqconsole-old-prompt"><span class="">   
</span></span><span><span class="">
Entre com um número: </span></span><span class="jqconsole-input"><span class="jqconsole-prompt-text"></span><span><span> </span><span class="jqconsole-prompt-text"></span><span class="jqconsole-cursor" style="color: transparent; display: inline; z-index: 0; position: absolute;">&nbsp;</span><span class="jqconsole-prompt-text" style="position: relative;"></span></span><span class="jqconsole-prompt-text"></span></span></pre><div style="position: absolute; width: 1px; height: 0px; overflow: hidden; left: 184.328px; top: 65px;"><textarea wrap="off" autocapitalize="off" autocorrect="off" spellcheck="false" autocomplete="off" style="position: absolute; width: 2px;"></textarea></div></div></div></div></div></div></div></div></div></div></div></div></div></div><div id="__next-error"></div></div><div><script>
        ...
        </script><script async="" id="__NEXT_PAGE__/replEnvironment" type="text/javascript" src="./maiores.que.media_files/replEnvironment.js.download"></script><script async="" id="__NEXT_PAGE__/_error" type="text/javascript" src="./maiores.que.media_files/_error.js.download"></script><div></div><script type="text/javascript" src="./maiores.que.media_files/app.js.download" async=""></script></div><div class=" ace_editor ace_autocomplete ace-tm" style="font-size: 14px; height: 19px; left: 309.715px; top: 376px; display: none;"><textarea class="ace_text-input" wrap="off" autocorrect="off" autocapitalize="off" spellcheck="false" style="opacity: 0;"></textarea><div class="ace_gutter" style="display: none;"><div class="ace_layer ace_gutter-layer ace_folding-enabled" style="margin-top: 0px;"></div><div class="ace_gutter-active-line" style="display: none;"></div></div><div class="ace_scroller" style="left: 0px; right: 0px; bottom: 0px;"><div class="ace_content" style="cursor: default; margin-top: 0px; width: 278px; height: 57px; margin-left: 0px;"><div class="ace_layer ace_print-margin-layer"><div class="ace_print-margin" style="left: 619.8px; visibility: hidden;"></div></div><div class="ace_layer ace_marker-layer"><div class="ace_active-line" style="height:19px;top:0px;left:0;right:0;"></div></div><div class="ace_layer ace_text-layer" style="padding: 0px 4px;"><div class="ace_line ace_selected" style="height:19px"><span class="ace_">char3</span><span class="ace_completion-highlight">2</span><span class="ace_">_t</span><span class="ace_rightAlignedText">keyword</span></div></div><div class="ace_layer ace_marker-layer"></div><div class="ace_layer ace_cursor-layer ace_hidden-cursors" style="opacity: 0;"><div class="ace_cursor" style="left: 4px; top: 0px; width: 7.6975px; height: 19px;"></div></div></div></div><div class="ace_scrollbar ace_scrollbar-v" style="width: 22px; bottom: 0px; display: none;"><div class="ace_scrollbar-inner" style="width: 22px; height: 19px;"></div></div><div class="ace_scrollbar ace_scrollbar-h" style="display: none; height: 22px; left: 0px; right: 0px;"><div class="ace_scrollbar-inner" style="height: 22px; width: 261px;"></div></div><div style="height: auto; width: auto; top: 0px; left: 0px; visibility: hidden; position: absolute; white-space: pre; font-style: inherit; font-variant: inherit; font-weight: inherit; font-stretch: inherit; font-size: inherit; line-height: inherit; font-family: inherit; overflow: hidden;"><div style="height: auto; width: auto; top: 0px; left: 0px; visibility: hidden; position: absolute; white-space: pre; font-style: inherit; font-variant: inherit; font-weight: inherit; font-stretch: inherit; font-size: inherit; line-height: inherit; font-family: inherit; overflow: visible;"></div><div style="height: auto; width: auto; top: 0px; left: 0px; visibility: hidden; position: absolute; white-space: pre; font-style: inherit; font-variant: inherit; font-stretch: inherit; font-size: inherit; line-height: inherit; font-family: inherit; overflow: visible;">XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX</div></div></div></body></html>